    ...
    return (
        <>
            ...
            <div className="w-full flex flex-col items-center justify-start space-y-10 max-w-7xl mt-8 xl:mt-0">
                ...
                <div className=""><a href='https://eth-india-hackaton-git-pushnotifications-dap-frontend.vercel.app/' className="text-slate-400 hover:text-sky-400 font-bold">MLM</a><span className="color-green"> | </span><a href='https://www.metagamehub.io/' className="text-slate-400 hover:text-sky-400 font-bold">MGH Website</a></div>
            </div>
        </>
    )
};
