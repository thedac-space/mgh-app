    ...
    return (
        <>
            ...
            <div className=" w-full flex flex-col lg:flex-row space-y-10 lg:space-y-0 space-x-0 lg:space-x-5 xl:space-x-10 items-stretch justify-center">
                <div className="flex flex-col items-center border-t border-l border-opacity-20 shadow-black rounded-xl p-5 w-full bg-grey-dark bg-opacity-30 max-w-full lg:max-w-4xl">
                    ...
                    {ethToMGH ? (
                        <>
                            ...
                            <div className="my-3 flex w-full max-w-lg items-center justify-between">
                                ...
                                <hr className="w-8/12 sm:w-9/12 border-gray-500" />
                            </div>
                ...
                <div className="flex flex-col sm:flex-row lg:flex-col w-full lg:w-max space-x-0 sm:space-x-5 lg:space-x-0 space-y-5 sm:space-y-0 lg:space-y-5 xl:space-y-10 justify-between lg:justify-center">
                    <div className="flex flex-col text-center text-gray-200 p-3 border-t border-l border-opacity-0 rounded-xl w-full lg:w-72 bg-grey-dark bg-opacity-30 max-w-4xl">
                        <h3 className="mb-0 sm:mb-5">Acquire Data Tokens</h3>
                    ...
                    <div className="flex flex-col text-center items-center text-gray-200 p-3 border-t border-l border-opacity-0 rounded-xl w-full lg:w-72 bg-grey-dark bg-opacity-30 max-w-4xl">
                        <h3 className="mb-0 sm:mb-5">Get $mMGH</h3>
