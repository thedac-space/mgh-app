            ...
            <div className="h-full w-full flex flex-row items-center justify-evenly">
                <div className="w-full flex flex-col items-center justify-start space-y-10 max-w-5xl">
                    ...
                    <div className="flex flex-col items-start border-t border-l border-opacity-20 shadow-blck rounded-xl p-5 w-full bg-grey-dark bg-opacity-30 text-left">
                        ...
                        <p className={`text-lg xl:text-xl font-medium text-gray-200 pt-5`}>Find the real value of The Sandbox LANDs with our machine learning pricing algorithm.</p>
                    </div>

                    <div className="flex space-x-10 items-stretch justify-between w-full">

                        <div className="flex flex-col justify-between max-w-md w-full space-y-5">
                            ...
                            <div className="flex flex-col items-start border-t border-l border-opacity-20 shadow-blck rounded-xl p-5 w-full bg-grey-dark bg-opacity-30 text-left">
                                <div className="relative flex flex-wrap items-center mb-2 pl-2 text-left w-full max-w-sm">
                                    ...
                                    <p className="absolute -top-6 left-0 pl-2 px-2 py-1 rounded-lg bg-black bg-opacity-10 backdrop-filter backdrop-blur font-medium text-xs text-gray-400 hidden peer-hover:block">Find LAND on Opensea &gt; Details &gt; Token ID</p>
                                </div>
                                <form onSubmit={handleIDSubmit} onInput={() => { setIdError(""); setCoordinatesError("") }} className="relative flex items-center w-full rounded-xl max-w-sm">
                                    <input required id="tokenID" type="text" placeholder="e.g. 72792" className={`bg-transparent w-full text-white font-medium py-4 px-4 focus:outline-none border ${idError ? "border-red-500 border-opacity-100" : "border-opacity-40 "} hover:border-opacity-100 focus:border-opacity-100 transition duration-300 ease-in-out rounded-xl placeholder-white placeholder-opacity-75`} />

                                    <button type="submit" className="absolute flex items-center justify-around bg-gray-200 hover:bg-white shadow-black hover:shadow-button transition ease-in-out duration-500 right-0 h-4/5 rounded-lg mr-1.5 w-12 xs:w-28">
                            ...
                            <div className="flex flex-col items-start border-t border-l border-opacity-20 shadow-blak rounded-xl p-5 w-full bg-grey-dark bg-opacity-30 text-left">
                                ...
                                <form onSubmit={handleCoordinatesSubmit} onInput={() => { setIdError(""); setCoordinatesError("") }} className="relative flex items-stretch justify-between space-x-5 w-full rounded-xl max-w-sm pr-2">
                                    <input required id="X" type="text" placeholder="X" className={`bg-transparent w-1/3 text-white font-medium py-4 px-4 focus:outline-none border ${coordinatesError ? "border-red-500 border-opacity-100" : "border-opacity-40 "} hover:border-opacity-100 focus:border-opacity-100 transition duration-300 ease-in-out rounded-xl placeholder-white placeholder-opacity-75`} />
                                    <input required id="Y" type="text" placeholder="Y" className={`bg-transparent w-1/3 text-white font-medium py-4 px-4 focus:outline-none border ${coordinatesError ? "border-red-500 border-opacity-100" : "border-opacity-40 "} hover:border-opacity-100 focus:border-opacity-100 transition duration-300 ease-in-out rounded-xl placeholder-white placeholder-opacity-75`} />

                                    <button type="submit" className="flex items-center justify-around bg-gray-200 hover:bg-white transition ease-in-out duration-500 rounded-xl m-1 shadow-black hover:shadow-button w-12 xs:w-32">
