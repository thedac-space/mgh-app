    ...
    return (
        <>
            ...
            <div className="h-full w-full flex flex-row items-center justify-evenly">
                <div className="h-full w-full flex flex-col items-center justify-start space-y-10 max-w-5xl">

                    <div className="flex flex-col items-start p-5 w-full h-72 bg-grey-darkest bg-opacity-30 border-t border-l border-opacity-20 rounded-3xl shadow-black">
                    ...
                    <div className="flex items-stretch justify-between w-full h-full">
                        ...
                        <div className="flex flex-col w-72 items-start bg-grey-darkest bg-opacity-30 border-t border-l border-opacity-20 rounded-3xl shadow-black">
