...
const TransactionModal = ({ onDismiss, loading, success, hash, chainId }: any) => {
    ...
    return (
        <div className="fixed top-0 left-0 flex items-center justify-center h-screen w-screen z-50">
            ...
            <div className="z-10 w-96 transform scale-85 sm:scale-100 flex flex-col items-center shadow-black text-center p-5 pt-10 space-y-10 rounded-xl border border-opacity-20 bg-grey-darkest bg-opacity-20 backdrop-filter backdrop-blur-xl text-gray-200">
                {loading &&
