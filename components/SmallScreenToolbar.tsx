...
const SmallScreenToolbar = () => {
    ...
    return (
        <>
            ...
            <div className="flex space-x-10 xl:hidden h-20 md:h-24 w-full items-center justify-between p-5 z-20 fixed top-0 left-0 backdrop-filter backdrop-blur-2xl bg-black bg-opacity-10">
