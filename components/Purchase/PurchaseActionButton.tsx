...
const PurchaseActionButton = ({
  ...
  return (
    <button
      onClick={onClick}
      disabled={disabled}
      className='z-30 disabled:opacity-50 disabled:hover:shadow-dark disabled:cursor-default mt-4 relative flex justify-center items-center  transition ease-in-out duration-500 shadow-dark rounded-xl w-full max-w-lg py-3 sm:py-4 group'
    >
